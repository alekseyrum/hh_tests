...
var base03_text = `...
... Время кончилось видео оборвалось
...`;
...
var base05_description = `Отдел кадров компании планирует внедрение новой информационной системы для работы с кандидатами на вакантные должности.
Для информационнной системы необходимо разработать модуль, который позволяет сформировать каталог для хранения информации о кандидатах в формате Имя,Отчество,Фамилия,Рейтинг.`;
var base05_text = ``;
